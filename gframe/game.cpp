...
bool Game::Initialize() {
	...
	device->setWindowCaption(L"YGOPro 20EX");
	...
	wchar_t strbuf[256];
	//modded
	myswprintf(strbuf, L"YGOPro 20EX Version:%X.0%X.%X", PRO_VERSION >> 12, (PRO_VERSION >> 4) & 0xff, PRO_VERSION & 0xf);
...
#endif
		if(cur_time >= 1000) {
			myswprintf(cap, L"YGOPro 20EX FPS: %d", fps);
